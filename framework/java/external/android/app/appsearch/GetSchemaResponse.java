...
public final class GetSchemaResponse {
    ...
    /**
     * This map contains all schemas and Android Roles that has access to the schema. All keys in
     * the map are prefixed with the package-database prefix. We do lazy fetch, the object will be
     * created when the user first time fetch it. The querier will have access to the schema type if
     * they hold ANY of allowed Roles. The value set represents {@link
     * android.app.appsearch.SetSchemaRequest.AppSearchSupportedRole}.
     */
    @Nullable private Map<String, Set<Integer>> mSchemasVisibleToRoles;

    /**
     * This map contains all schemas and Android Permissions that are required to access the schema.
     * All keys in the map are prefixed with the package-database prefix. We do lazy fetch, the
     * object will be created when the user first time fetch it. The querier must have ALL required
     * permissions to read {@link GenericDocument} objects under the {@code schemaType}. The value
     * set represents {@link android.app.appsearch.SetSchemaRequest.AppSearchSupportedPermission}.
     */
    @Nullable private Map<String, Set<Integer>> mSchemasVisibleToPermissions;
    ...
    /**
     * Returns a mapping of schema types to the set of Android roles that have access to that schema
     * type.
     *
     ...
     *     are {@link SetSchemaRequest#ROLE_HOME} and {@link SetSchemaRequest#ROLE_ASSISTANT}
     * @hide
     */
    @NonNull
    public Map<String, Set<Integer>> getAllowedRolesForSchemaTypeVisibility() {
        ...
        if (mSchemasVisibleToRoles == null) {
            Bundle schemaVisibleToRolesBundle = mBundle.getBundle(SCHEMAS_VISIBLE_TO_ROLES_FIELD);
     ...
     *     The supported Permission are {@link SetSchemaRequest#READ_SMS}, {@link
    ...
    public Map<String, Set<Integer>> getRequiredPermissionsForSchemaTypeVisibility() {
        ...
        if (mSchemasVisibleToPermissions == null) {
            ...
            for (String key : schemaVisibleToPermissionBundle.keySet()) {
                copy.put(
                        key,
                        new ArraySet<>(schemaVisibleToPermissionBundle.getIntegerArrayList(key)));
            }
    ...
    public static final class Builder {
         ...
         *     Features#ROLE_AND_PERMISSION_WITH_GET_VISIBILITY} by this backend/Android API level.
         * @hide
         */
         ...
         *
         * <p>The querier could read {@link GenericDocument} objects under the provided {@code
         * schemaType} if they hold ANY of allowed Roles.
         *
         * <p>The supported Role are {@link SetSchemaRequest#ROLE_HOME} and {@link
        ...
        public Builder setAllowedRolesForSchemaTypeVisibility(
            ...
            for (int role : visibleToRoles) {
                Preconditions.checkArgumentInRange(
                        role, SetSchemaRequest.ROLE_HOME, SetSchemaRequest.ROLE_ASSISTANT, "role");
            }
            resetIfBuilt();
         ...
         *
         * <p>The supported Permission are {@link SetSchemaRequest#READ_SMS}, {@link
         * SetSchemaRequest#READ_CALENDAR}, {@link SetSchemaRequest#READ_CONTACTS}, {@link
         * SetSchemaRequest#READ_EXTERNAL_STORAGE}.
         *
        ...
        public Builder setRequiredPermissionsForSchemaTypeVisibility(
            ...
            resetIfBuilt();
            mSchemasVisibleToPermissions.putIntegerArrayList(
                    schemaType, new ArrayList<>(visibleToPermissions));
            return this;
        }
